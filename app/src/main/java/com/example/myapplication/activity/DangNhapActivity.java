...
public class DangNhapActivity extends AppCompatActivity {
    TextView txtdangki, txtresetpass, txtkhampha;
    EditText email,pass;
    ...
    private void initControll() {
        ...
        txtkhampha.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DangNhapActivity.this, KhamPhaActivity.class);
                // Bắt đầu Intent
                startActivity(intent);
            }
        });
                ...
                .subscribe(
                        userModel -> {
                            if(userModel.isSuccess()) {
                               ...
                               // Log.d("loggg", Utils.user_current.getId()+ "");
    ...
    private void initView() {
        ...
        txtkhampha=findViewById(R.id.txtkhampha);
